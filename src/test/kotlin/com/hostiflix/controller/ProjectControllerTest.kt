...
class ProjectControllerTest {
    ...
    fun `should return a list of the customers projects`() {
        ...
        mockMvc
            ...
            .andExpect(jsonPath("$.projects[0].createdAt", `is`(project1.createdAt)))
            ...
            .andExpect(jsonPath("$.projects[0].branches[0].jobs[0].status", `is`(project1.branches[0].jobs[0].status)))
            .andExpect(jsonPath("$.projects[0].branches[0].jobs[0].createdAt", `is`(project1.branches[0].jobs[0].createdAt)))
            .andExpect(jsonPath("$.projects[0].branches[0].jobs[0].finishedAt", `is`(project1.branches[0].jobs[0].finishedAt)))
            .andExpect(jsonPath("$.projects[0].branches[0].jobs[1].id", `is`(project1.branches[0].jobs[1].id)))
            .andExpect(jsonPath("$.projects[0].branches[0].jobs[1].status", `is`(project1.branches[0].jobs[1].status)))
            .andExpect(jsonPath("$.projects[0].branches[0].jobs[1].createdAt", `is`(project1.branches[0].jobs[1].createdAt)))
            .andExpect(jsonPath("$.projects[0].branches[0].jobs[1].finishedAt", `is`(project1.branches[0].jobs[1].finishedAt)))
            ...
            .andExpect(jsonPath("$.projects[0].branches[1].jobs[0].status", `is`(project1.branches[1].jobs[0].status)))
            .andExpect(jsonPath("$.projects[0].branches[1].jobs[0].createdAt", `is`(project1.branches[1].jobs[0].createdAt)))
            .andExpect(jsonPath("$.projects[0].branches[1].jobs[0].finishedAt", `is`(project1.branches[1].jobs[0].finishedAt)))
            .andExpect(jsonPath("$.projects[0].branches[1].jobs[1].id", `is`(project1.branches[1].jobs[1].id)))
            .andExpect(jsonPath("$.projects[0].branches[1].jobs[1].status", `is`(project1.branches[1].jobs[1].status)))
            .andExpect(jsonPath("$.projects[0].branches[1].jobs[1].createdAt", `is`(project1.branches[1].jobs[1].createdAt)))
            .andExpect(jsonPath("$.projects[0].branches[1].jobs[1].finishedAt", `is`(project1.branches[1].jobs[1].finishedAt)))
            ...
            .andExpect(jsonPath("$.projects[1].createdAt", `is`(project2.createdAt)))
            ...
            .andExpect(jsonPath("$.projects[1].branches[0].jobs[0].status", `is`(project2.branches[0].jobs[0].status)))
            .andExpect(jsonPath("$.projects[1].branches[0].jobs[0].createdAt", `is`(project2.branches[0].jobs[0].createdAt)))
            .andExpect(jsonPath("$.projects[1].branches[0].jobs[0].finishedAt", `is`(project2.branches[0].jobs[0].finishedAt)))
            .andExpect(jsonPath("$.projects[1].branches[0].jobs[1].id", `is`(project2.branches[0].jobs[1].id)))
            .andExpect(jsonPath("$.projects[1].branches[0].jobs[1].status", `is`(project2.branches[0].jobs[1].status)))
            .andExpect(jsonPath("$.projects[1].branches[0].jobs[1].createdAt", `is`(project2.branches[0].jobs[1].createdAt)))
            .andExpect(jsonPath("$.projects[1].branches[0].jobs[1].finishedAt", `is`(project2.branches[0].jobs[1].finishedAt)))
            ...
            .andExpect(jsonPath("$.projects[1].branches[1].jobs[0].status", `is`(project2.branches[1].jobs[0].status)))
            .andExpect(jsonPath("$.projects[1].branches[1].jobs[0].createdAt", `is`(project2.branches[1].jobs[0].createdAt)))
            .andExpect(jsonPath("$.projects[1].branches[1].jobs[0].finishedAt", `is`(project2.branches[1].jobs[0].finishedAt)))
            .andExpect(jsonPath("$.projects[1].branches[1].jobs[1].id", `is`(project2.branches[1].jobs[1].id)))
            .andExpect(jsonPath("$.projects[1].branches[1].jobs[1].status", `is`(project2.branches[1].jobs[1].status)))
            .andExpect(jsonPath("$.projects[1].branches[1].jobs[1].createdAt", `is`(project2.branches[1].jobs[1].createdAt)))
            .andExpect(jsonPath("$.projects[1].branches[1].jobs[1].finishedAt", `is`(project2.branches[1].jobs[1].finishedAt)))
    }
    ...
    fun `should return a project by Id`() {
        ...
        mockMvc
            ...
            .andExpect(jsonPath("$.createdAt", `is`(project.createdAt)))
            ...
            .andExpect(jsonPath("$.branches[0].jobs[0].status", `is`(project.branches[0].jobs[0].status)))
            .andExpect(jsonPath("$.branches[0].jobs[0].createdAt", `is`(project.branches[0].jobs[0].createdAt)))
            .andExpect(jsonPath("$.branches[0].jobs[0].finishedAt", `is`(project.branches[0].jobs[0].finishedAt)))
            .andExpect(jsonPath("$.branches[0].jobs[1].id", `is`(project.branches[0].jobs[1].id)))
            .andExpect(jsonPath("$.branches[0].jobs[1].status", `is`(project.branches[0].jobs[1].status)))
            .andExpect(jsonPath("$.branches[0].jobs[1].createdAt", `is`(project.branches[0].jobs[1].createdAt)))
            .andExpect(jsonPath("$.branches[0].jobs[1].finishedAt", `is`(project.branches[0].jobs[1].finishedAt)))
            ...
            .andExpect(jsonPath("$.branches[1].jobs[0].status", `is`(project.branches[1].jobs[0].status)))
            .andExpect(jsonPath("$.branches[1].jobs[0].createdAt", `is`(project.branches[1].jobs[0].createdAt)))
            .andExpect(jsonPath("$.branches[1].jobs[0].finishedAt", `is`(project.branches[1].jobs[0].finishedAt)))
            .andExpect(jsonPath("$.branches[1].jobs[1].id", `is`(project.branches[1].jobs[1].id)))
            .andExpect(jsonPath("$.branches[1].jobs[1].status", `is`(project.branches[1].jobs[1].status)))
            .andExpect(jsonPath("$.branches[1].jobs[1].createdAt", `is`(project.branches[1].jobs[1].createdAt)))
            .andExpect(jsonPath("$.branches[1].jobs[1].finishedAt", `is`(project.branches[1].jobs[1].finishedAt)))
    }
    ...
    fun `should create and return new project`() {
        ...
        mockMvc
            ...
            .andExpect(jsonPath("$.createdAt", `is`(newProject.createdAt)))
            ...
            .andExpect(jsonPath("$.branches[0].jobs[0].status", `is`(newProject.branches[0].jobs[0].status)))
            .andExpect(jsonPath("$.branches[0].jobs[0].createdAt", `is`(newProject.branches[0].jobs[0].createdAt)))
            .andExpect(jsonPath("$.branches[0].jobs[0].finishedAt", `is`(newProject.branches[0].jobs[0].finishedAt)))
            .andExpect(jsonPath("$.branches[0].jobs[1].id", `is`(newProject.branches[0].jobs[1].id)))
            .andExpect(jsonPath("$.branches[0].jobs[1].status", `is`(newProject.branches[0].jobs[1].status)))
            .andExpect(jsonPath("$.branches[0].jobs[1].createdAt", `is`(newProject.branches[0].jobs[1].createdAt)))
            .andExpect(jsonPath("$.branches[0].jobs[1].finishedAt", `is`(newProject.branches[0].jobs[1].finishedAt)))
            ...
            .andExpect(jsonPath("$.branches[1].jobs[0].status", `is`(newProject.branches[1].jobs[0].status)))
            .andExpect(jsonPath("$.branches[1].jobs[0].createdAt", `is`(newProject.branches[1].jobs[0].createdAt)))
            .andExpect(jsonPath("$.branches[1].jobs[0].finishedAt", `is`(newProject.branches[1].jobs[0].finishedAt)))
            .andExpect(jsonPath("$.branches[1].jobs[1].id", `is`(newProject.branches[1].jobs[1].id)))
            .andExpect(jsonPath("$.branches[1].jobs[1].status", `is`(newProject.branches[1].jobs[1].status)))
            .andExpect(jsonPath("$.branches[1].jobs[1].createdAt", `is`(newProject.branches[1].jobs[1].createdAt)))
            .andExpect(jsonPath("$.branches[1].jobs[1].finishedAt", `is`(newProject.branches[1].jobs[1].finishedAt)))
    }
    ...
    fun `should return updated project`() {
        ...
        mockMvc
            ...
            .andExpect(jsonPath("$.createdAt", `is`(updatedProject.createdAt)))
            ...
            .andExpect(jsonPath("$.branches[0].jobs[0].status", `is`(updatedProject.branches[0].jobs[0].status)))
            .andExpect(jsonPath("$.branches[0].jobs[0].createdAt", `is`(updatedProject.branches[0].jobs[0].createdAt)))
            .andExpect(jsonPath("$.branches[0].jobs[0].finishedAt", `is`(updatedProject.branches[0].jobs[0].finishedAt)))
            .andExpect(jsonPath("$.branches[0].jobs[1].id", `is`(updatedProject.branches[0].jobs[1].id)))
            .andExpect(jsonPath("$.branches[0].jobs[1].status", `is`(updatedProject.branches[0].jobs[1].status)))
            .andExpect(jsonPath("$.branches[0].jobs[1].createdAt", `is`(updatedProject.branches[0].jobs[1].createdAt)))
            .andExpect(jsonPath("$.branches[0].jobs[1].finishedAt", `is`(updatedProject.branches[0].jobs[1].finishedAt)))
            ...
            .andExpect(jsonPath("$.branches[1].jobs[0].status", `is`(updatedProject.branches[1].jobs[0].status)))
            .andExpect(jsonPath("$.branches[1].jobs[0].createdAt", `is`(updatedProject.branches[1].jobs[0].createdAt)))
            .andExpect(jsonPath("$.branches[1].jobs[0].finishedAt", `is`(updatedProject.branches[1].jobs[0].finishedAt)))
            .andExpect(jsonPath("$.branches[1].jobs[1].id", `is`(updatedProject.branches[1].jobs[1].id)))
            .andExpect(jsonPath("$.branches[1].jobs[1].status", `is`(updatedProject.branches[1].jobs[1].status)))
            .andExpect(jsonPath("$.branches[1].jobs[1].createdAt", `is`(updatedProject.branches[1].jobs[1].createdAt)))
            .andExpect(jsonPath("$.branches[1].jobs[1].finishedAt", `is`(updatedProject.branches[1].jobs[1].finishedAt)))
    }
