...
class ProjectControllerTest {
    ...
    fun `should return a list of the customers projects`() {
        ...
        mockMvc
            ...
            .andExpect(jsonPath("$.projects[0].hash", `is`(project1.projectHash!!.id)))
            ...
            .andExpect(jsonPath("$.projects[0].type", `is`(project1.type.toString())))
            ...
            .andExpect(jsonPath("$.projects[1].hash", `is`(project2.projectHash!!.id)))
            ...
            .andExpect(jsonPath("$.projects[1].type", `is`(project2.type.toString())))
    ...
    fun `should return a project by Id`() {
        ...
        mockMvc
            ...
            .andExpect(jsonPath("$.hash", `is`(project.projectHash!!.id)))
            ...
            .andExpect(jsonPath("$.type", `is`(project.type.toString())))
    ...
    fun `should create and return new project`() {
        ...
        mockMvc
            ...
            .andExpect(jsonPath("$.hash", `is`(newProject.projectHash!!.id)))
            ...
            .andExpect(jsonPath("$.type", `is`(newProject.type.toString())))
    ...
    fun `should return updated project`() {
        ...
        mockMvc
            ...
            .andExpect(jsonPath("$.hash", `is`(updatedProject.projectHash!!.id)))
            ...
            .andExpect(jsonPath("$.type", `is`(updatedProject.type.toString())))
